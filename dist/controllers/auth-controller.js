...
exports.findUser = exports.kakaoCallback = void 0;
...
var findUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, existUser, user, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.status(type_1.StatusCodeEnum.OK).json({
                    user: user,
                });
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                res.status(type_1.StatusCodeEnum.NOT_FOUND).send({
                    message: type_1.ErrorMessageEnum.NOT_FOUND_USER,
                });
                return [3 /*break*/, 3];
